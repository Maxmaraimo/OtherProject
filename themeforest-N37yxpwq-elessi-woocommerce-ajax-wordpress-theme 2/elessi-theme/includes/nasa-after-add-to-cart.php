...
?>
<a class="nasa-stclose popup-cart-close" href="javascript:void(0);" title="<?php echo esc_attr__('Close (Esc)', 'elessi-theme'); ?>"></a>
...
<form class="after-add-to-cart-form<?php echo isset($nasa_opt['auto_update_cart']) && $nasa_opt['auto_update_cart'] ? ' qty-auto-update': ''; ?>" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <div class="nasa-table-wrap nasa-active">
        <table class="after-add-to-cart-shop_table shop_table responsive woocommerce-cart-form__contents">
            <thead>
                <tr>
    ...
    <div class="nasa-after-add-to-cart-buttons margin-top-20">
        ...
        <a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="popup-view-cart-button button alt wc-forward right rtl-left" title="<?php esc_attr_e('View cart', 'elessi-theme'); ?>">
            <?php esc_html_e('View cart', 'elessi-theme'); ?>
        </a>
